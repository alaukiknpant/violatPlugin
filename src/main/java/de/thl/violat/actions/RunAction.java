...
//import de.thl.violat.run.InferConfigurationFactory;
//import de.thl.violat.run.InferConfigurationType;
...
//    private static final Logger log = Logger.getInstance(de.thl.intellijinfer.actions.RunAction.class);
...
//            log.error("No valid Violat Installation: Go to the Violat Settings and add one please");
//            return;
//        }
//
